...
public:
	...
	FeasibleSolution(std::list<int> sol, double cost, int sepIntVal, int sourceRoute, int addedNode, double maxPathLength);//constructor
...
public:	
	...
	Tabusearch(FeasibleSolution febSol, std::map<int, int> demandVec, std::vector<std::vector<double>> disMat, int kChain, int swapChain, int maxRouteCapacity, double maxPathLength);//constructor
	Tabusearch(FeasibleSolution febSol, std::map<int, int> demandVec, std::vector<std::vector<double>> disMat, int maxRouteCapacity, double maxPathLength);//constructor
